...
import data from "../../constants/line_3.json";
import data_about from "../../constants/line3_about.json";
...
const IndexPage = () => {
  ...
  return (
    <Layout title="Невско-Василиеостровская">
      <Header sec_title="Невско-Василиеостровская линия" />
