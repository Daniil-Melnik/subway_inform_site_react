...
import data from "../../constants/line_2.json";
import data_about from "../../constants/line2_about.json";
...
const IndexPage = () => {
  ...
  return (
    <Layout title="Московско-Петроградская">
      <Header sec_title="Московско-Петроградская линия" />
